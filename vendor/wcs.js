  ...
  WCS.Mapper = (function() {
    ...
    function Mapper(header) {
      ...
      this.coordinateToPixel = function() {
        return Mapper.prototype.coordinateToPixel.apply(_this, arguments);
      };
      this.pixelToCoordinate = function() {
        return Mapper.prototype.pixelToCoordinate.apply(_this, arguments);
      };
      this.fromCelestial = function(ra, dec) {
        return Mapper.prototype.fromCelestial.apply(_this, arguments);
      };
      this.toCelestial = function(phi, theta) {
        return Mapper.prototype.toCelestial.apply(_this, arguments);
      };
      this.fromIntermediate = function(proj) {
        return Mapper.prototype.fromIntermediate.apply(_this, arguments);
      };
      this.toIntermediate = function(points) {
        return Mapper.prototype.toIntermediate.apply(_this, arguments);
      };
      this.computeCelestialParameters = function(phi0, theta0) {
        return Mapper.prototype.computeCelestialParameters.apply(_this, arguments);
      };
      this.getSipCoefficients = function(header) {
        return Mapper.prototype.getSipCoefficients.apply(_this, arguments);
      };
      this.setProjection = function(header) {
        return Mapper.prototype.setProjection.apply(_this, arguments);
      };
      this.derivePC = function(header) {
        return Mapper.prototype.derivePC.apply(_this, arguments);
      };
      this.checkCard = function(header, key, dimensions) {
        return Mapper.prototype.checkCard.apply(_this, arguments);
      };
      this.verifyHeader = function(header) {
        return Mapper.prototype.verifyHeader.apply(_this, arguments);
      };
      this.wcsobj = {};
